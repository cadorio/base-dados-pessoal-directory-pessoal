...
|--------------|-----------------------------|---------------------------------------------------------------|
| Usuarios     | UserID, Nome, Email, DataCriacao | Armazena informações dos usuários.                           |
| Repositorios | RepoID, Nome, Descricao, Linguagem, UltimaAtualizacao, CommitsCount, UserID | Armazena informações dos repositórios. |
| Branches     | BranchID, Nome, RepoID      | Armazena informações dos branches de repositórios.           |
...
| Colaboradores | RepoID, UserID              | Tabela de associação entre usuários e repositórios.           |
